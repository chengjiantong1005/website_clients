...
export default class Home extends Component {
  ...
  render() {
    let { modalVisible, leave, mouseIndex, showVideo } = this.state;
    ...
    return [
      ...
      <div key="content" className={`content ${modalClassName}`}>
        ...
        <IconList />
        <div className="copy-right" onAnimationEnd={this.playVideo}>
          {" "}
      ...
      showVideo ? (
        <div className="video">
          <video
            ...
            autoplay="autoplay"
            muted="muted"
            onEnded={this.palyEnd}
          >
            <source
              src={require("../video/pushwebsitetest720.mp4")}
              type="video/mp4"
            />
            <source
              src={require("../video/pushwebsitetest1080.mp4")}
              type="video/mp4"
            />
          </video>{" "}
        </div>
